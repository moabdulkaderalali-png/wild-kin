...
export const ANIMALS: AnimalDef[] = [
  ...
  },
  {
    ...
    special: {
      ...
      duration: 5,
      power: 2,
      desc: "5 s doppelt so schnell.",
    },
    biomes: ["river", "lake", "swamp"],
    diet: "herbivore",
    scale: 1.02,
    aquatic: true,
    fastSwimmer: true,
    ...
    voice: { freq: 110, type: "sawtooth", dur: 1.0, wobble: 60 },
    note: "Massiger Koloss – im Wasser wie an Land gefährlich.",
  },
  {
    id: "elephant",
    name: "Elefant",
    ...
    special: {
      ...
      duration: 0.5,
      power: 120,
      desc: "Stürmt blitzschnell nach vorne und trifft alles für 120 Schaden.",
    },
    biomes: ["savanna", "grass", "jungle"],
    diet: "herbivore",
    scale: 1.29,
    bounty: 1200,
    body: {
    ...
    voice: { freq: 90, type: "sawtooth", dur: 1.2, wobble: 240 },
    note: "Größtes Landtier – nahezu unaufhaltsam.",
  },
  {
    id: "polarbear",
    name: "Polarbär",
    ...
    special: {
      ...
      duration: 5,
      power: 1.6,
      desc: "5 s deutlich schneller auf der Jagd.",
    },
    biomes: ["snow", "ice"],
    diet: "carnivore",
    scale: 0.94,
    ...
    voice: { freq: 160, type: "sawtooth", dur: 0.9, wobble: 70 },
    note: "Riesiger Eisjäger mit Biss und Pfotenhieb.",
  },
  {
    id: "giraffe",
    name: "Giraffe",
    ...
    special: {
      ...
      duration: 0.6,
      power: 80,
      desc: "Wuchtiger Tritt nach hinten: 80 Schaden.",
    },
    biomes: ["savanna", "grass"],
    diet: "herbivore",
    scale: 0.98,
    ...
    voice: { freq: 200, type: "triangle", dur: 0.5, wobble: 80 },
    note: "Sehr schnell und mit tödlichen Tritten.",
  },
  {
    id: "rhino",
    name: "Nashorn",
    ...
    special: {
      ...
      power: 150,
      speed: 300,
      desc: "2 s Vollgas – alles auf dem Weg nimmt 150 Schaden.",
    },
    biomes: ["savanna", "grass"],
    diet: "herbivore",
    scale: 0.87,
    ...
    voice: { freq: 120, type: "sawtooth", dur: 0.9, wobble: 90 },
    note: "Gepanzerter Panzerbrecher der Savanne.",
  },
  {
    id: "titanoboa",
    name: "Titanoboa",
    ...
    sprintFactor: 1.25,
    stamina: 14,
    attacks: [bite(60, 46, { windup: 0.14 })],
    special: {
      name: "Würgegriff",
      kind: "squeeze",
      cooldown: 20,
      duration: 10,
      power: 2,
      desc: "Würgt 10 s – der Schaden verdoppelt sich jede Sekunde (2, 4, 8 …).",
    },
    biomes: ["river", "lake", "swamp", "jungle"],
    diet: "carnivore",
    scale: 1.2,
    ...
    voice: { freq: 1800, type: "sawtooth", dur: 1.0, wobble: 50 },
    note: "Urzeitliche Riesenschlange – erdrückt alles.",
  },
  {
    id: "spinosaurus",
    name: "Spinosaurus",
    ...
    sprintFactor: 1.2,
    stamina: 12,
    attacks: [bite(130, 56, { windup: 0.2 })],
    special: {
      name: "Maulgriff",
      kind: "carry",
      cooldown: 20,
      duration: 5,
      power: 70,
      desc: "Hält die Beute 5 s im Maul fest – 70 Schaden pro Sekunde.",
    },
    biomes: ["river", "lake", "swamp", "jungle"],
    diet: "carnivore",
    scale: 1.25,
    ...
    voice: { freq: 100, type: "sawtooth", dur: 1.3, wobble: 120 },
    note: "Der größte Raubsaurier – im Wasser wie an Land tödlich.",
  },
];
...
export const PREY: AnimalDef[] = [
  ...
  },
  {
    ...
    special: {
      ...
      power: 120,
      speed: 260,
      desc: "Richtet sich auf und rammt nach vorne.",
    },
    biomes: ["snow", "mountain", "forest"],
    diet: "carnivore",
    scale: 1.15,
    aquatic: true,
    fastSwimmer: true,
    ...
    voice: { freq: 180, type: "sawtooth", dur: 0.9, wobble: 80 },
    note: "Massiver Ursprungsräuber mit aufgerichteter Stufe.",
  },
  {
    ...MOUSE,
    id: "penguin",
  ...
  },
  {
    ...
    sprintFactor: 1.18,
    stamina: 12,
    attacks: [bite(200, 56, { windup: 0.2 })],
    special: {
      name: "Maulgriff",
      kind: "carry",
      cooldown: 20,
      duration: 2,
      power: 400,
      desc: "Hält die Beute 2 s im Maul fest und verursacht 400 Schaden/s.",
    },
    biomes: ["savanna", "grass", "jungle", "swamp", "river"],
    diet: "carnivore",
    scale: 1.32,
    aquatic: true,
    fastSwimmer: true,
    ...
    voice: { freq: 120, type: "sawtooth", dur: 1.1, wobble: 100 },
    note: "Riesiger Jäger mit zerstörerischem Maulgriff.",
  },
  {
    id: "deinosuchus",
    name: "Deinosuchus",
    ...
    sprintFactor: 1.22,
    stamina: 9,
    attacks: [bite(170, 52, { windup: 0.2 })],
    special: {
      name: "Zugriff",
      kind: "carry",
      cooldown: 20,
      duration: 7,
      power: 150,
      desc: "Schleppt das Ziel 7 s mit sich und verursacht 150 Schaden/s.",
    },
    biomes: ["river", "lake", "swamp", "jungle"],
    diet: "carnivore",
    scale: 1.14,
    ...
    voice: { freq: 150, type: "sawtooth", dur: 0.95, wobble: 50 },
    note: "Aquatischer Jäger mit großem Zugriffsgriff.",
  },
];
